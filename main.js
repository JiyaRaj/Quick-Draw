...
document.getElementById("draw").innerHTML="You have to draw: " + quick_draw_data_set[random_no];
...
function check_sketch(){
    timer_counter++;
    document.getElementById("time").innerHTML="Your time- " + timer_counter;
...
function gotResults(error,results){
    ...
    drawn_sketch.replaceAll("_", ' ');
    document.getElementById("sketch").innerHTML="Your Sketch is: "+drawn_sketch;
    document.getElementById("con").innerHTML="Confidence: "+ (results[0].confidence*100).toFixed(2)+"%";
